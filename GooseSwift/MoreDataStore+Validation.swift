...
extension MoreDataStore {
  nonisolated static func writeRawValidationSidecars(
    ...
    GooseFileProtection.apply(GooseFileProtection.foregroundOnly, to: sidecarURL, artifact: .validationSidecar)
    ...
    GooseFileProtection.apply(GooseFileProtection.foregroundOnly, to: reviewURL, artifact: .validationSidecar)
    ...
    GooseFileProtection.apply(GooseFileProtection.foregroundOnly, to: runbookURL, artifact: .validationSidecar)
